...
## Project Structure
    ...
    ├── templatetestingaapp_27443  # Django project configurations
...
1. Clone this repo and `cd templatetestingaapp_27443`
...
2. Clone this repo and `cd templatetestingaapp_27443`
